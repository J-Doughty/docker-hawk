...
function SidebarLink({ sidebarLink, sidebarExpanded }: { sidebarLink: SidebarLink, sidebarExpanded: boolean }) {
    return <Link to={sidebarLink.link}>
...
export default function Sidebar({ children, sidebarLinks }: { children: React.ReactNode, sidebarLinks: SidebarLink[][] }) {
